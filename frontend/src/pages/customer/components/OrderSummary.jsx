...
import { fetchProductDetailsFromCart, removeFromCart } from '../../../redux/userSlice'; // Add a removeFromCart action
...
const OrderSummary = ({ handleNext, handleBack }) => {
    ...
    const handleRemoveItem = (productId) => {
        dispatch(removeFromCart(productId)); // Dispatch Redux action to remove item
    };
