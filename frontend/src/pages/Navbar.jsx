...
const Navbar = () => {
  ...
  return (
    <AppBar position="sticky">
      <Container maxWidth="xl" sx={{ backgroundColor: "#f96d00" }}>
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: "none", md: "flex" } }}>
            <Search />
            <ProductsMenu dropName="Categories" sx={{ color: "#000000" }} />
          ...
          {currentRole === null && (
            <Box sx={{ flexGrow: 0, display: { xs: "none", md: "flex" } }}>
              <Button
                ...
                sx={{ my: 2, color: "white", display: "block", backgroundColor:"#000000" }}
              >
                Sign in
              </Button>
              <Menu
                ...
                >
                  <Avatar
                    sx={{
                      ...
                      "&:hover": {
                        backgroundColor: "#2d4059", // Change to black on hover
                      },
                    }}
                  >
